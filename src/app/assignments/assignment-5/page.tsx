...
export default function Page() {
  return (
    <>
      <div className="w-full min-h-screen flex items-center justify-center p-4 sm:px-8">
        <div className="max-w-screen-xl mx-auto space-y-28">
          {/* Navbar */}
          {/* content */}
          <div className="flex flex-col w-full lg:flex-row gap-8 h-fit">
            {/* left section */}
            <div className="w-full lg:w-5/6">
              ...
              <div className="flex flex-col lg:flex-row gap-4 pt-8 justify-between">
                ...
                <div className="basis-1/3">
                  <h1 className="text-[2.75rem] lg:text-[3.25rem] leading-none font-extrabold text-slate-900">
